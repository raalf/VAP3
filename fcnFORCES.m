...
% %% Viscous wrapper
[OUTP.vecCLv, OUTP.vecCD, OUTP.vecPREQ, OUTP.vecLD, matROTORCDP, vecDELNDIST] = fcnVISCOUS(OUTP.vecCL, OUTP.vecCDI, COND.vecVEHVINF, INPU.vecAREA, COND.valDENSITY, VISC.valKINV, SURF.vecDVENFREE, SURF.vecDVENIND, ...
    ...
    FLAG.TRI, FLAG.STEADY, FLAG.GPU, SURF.valNELE, INPU.vecPANELROTOR, FLAG.VISCOUS);
