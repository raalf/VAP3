...
if max(SURF.vecDVEROTOR) > 0
    [OUTP.vecCT(valTIMESTEP,:), OUTP.vecCP(valTIMESTEP,:), OUTP.vecCPI(valTIMESTEP,:)] = fcnROTORFORCE(matROTORCDP, en, SURF.vecDVENFREE, SURF.vecDVENIND, inddrag, SURF.matUINF, SURF.vecDVEROTOR, VEHI.matVEHROT, INPU.matROTORAXIS, COND.vecROTORRPM, INPU.vecROTDIAM, SURF.matUINFROT, SURF.vecQARM, SURF.vecDVEVEHICLE, vecDELNDIST);
else
    OUTP.vecCT = nan;
    OUTP.vecCP = nan;
    OUTP.vecCPI = nan;
