...
% %% Viscous wrapper
[OUTP.vecCLv, OUTP.vecCD, OUTP.vecPREQ, OUTP.vecLD, matROTORCDP] = fcnVISCOUS(OUTP.vecCL, OUTP.vecCDI, COND.vecVEHVINF, INPU.vecAREA, COND.valDENSITY, VISC.valKINV, SURF.vecDVENFREE, SURF.vecDVENIND, ...
