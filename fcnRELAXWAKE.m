function WAKE = fcnRELAXWAKE(valTIMESTEP, SURF, WAKE, COND, FLAG)
...
[ WAKE.matWDVEMPIND ] = fcnINDVEL(WAKE.matWDVEMP,SURF.valNELE, SURF.matDVE, SURF.matVLST, SURF.matCOEFF, SURF.vecK, SURF.vecDVEHVSPN, SURF.vecDVEHVCRD, SURF.vecDVEROLL, SURF.vecDVEPITCH, SURF.vecDVEYAW, SURF.vecDVELESWP, SURF.vecDVETESWP, SURF.vecDVESYM,...
    WAKE.valWNELE, WAKE.matWDVE, WAKE.matWVLST, WAKE.matWCOEFF, WAKE.vecWK, WAKE.vecWDVEHVSPN, WAKE.vecWDVEHVCRD, WAKE.vecWDVEROLL, WAKE.vecWDVEPITCH, WAKE.vecWDVEYAW, WAKE.vecWDVELESWP, WAKE.vecWDVETESWP, WAKE.valWSIZE, valTIMESTEP, 0, FLAG.STEADY, FLAG.GPU);
