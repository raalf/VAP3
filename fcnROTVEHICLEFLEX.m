function [matVLST, matCENTER,...
    matROTORHUBGLOB, matROTORAXIS, matNTVLST, vecVEHCG, matEALST, vecWINGCG, vecPAYLCG, vecFUSECG, vecTAILCG, vecBFRAME] = fcnROTVEHICLEFLEX( matDVE, matNPDVE, matVLST, ...
    matCENTER, valVEHICLES, vecDVEVEHICLE, matVEHORIG, ...
    matVEHROT, matROTORHUB, matROTORAXIS, vecROTORVEH, matNTVLST, vecVEHCG, matEALST, vecWINGCG, vecPAYLCG, vecFUSECG, vecTAILCG, vecBFRAME)
