...
if FLAG.PREVIEW ~= 1 && max(SURF.vecDVEROTOR) > 0
    ...
    for i = 1:max(SURF.vecDVEWING)
       OUTP.WING(i).vecCLDIST_AVG = fcnTIMEAVERAGE(OUTP.WING(i).vecCLDIST, COND.vecROTORRPM, COND.valDELTIME);
       OUTP.WING(i).vecCDPDIST_AVG = fcnTIMEAVERAGE(OUTP.WING(i).vecCDPDIST, COND.vecROTORRPM, COND.valDELTIME);
    end
