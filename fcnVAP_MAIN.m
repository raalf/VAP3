...
if FLAG.PREVIEW ~= 1 && max(SURF.vecDVEROTOR) > 0
    ...
    OUTP.DISTRIBUTIONS.vecTORQUEDIST_AVG = fcnTIMEAVERAGE(OUTP.DISTRIBUTIONS.vecTORQUEDIST, COND.vecROTORRPM, COND.valDELTIME);
    OUTP.DISTRIBUTIONS.vecTHRUSTDIST_AVG = fcnTIMEAVERAGE(OUTP.DISTRIBUTIONS.vecTHRUSTDIST, COND.vecROTORRPM, COND.valDELTIME);
