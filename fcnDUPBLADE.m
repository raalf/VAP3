function [vecPANELROTOR, vecN, vecM, matVLST0, matCENTER0, matDVE, matADJE, vecDVEVEHICLE, ...
    ...
    vecDVETIP, vecDVELE, vecDVETE, vecDVEROTORBLADE, vecDVESYMEDGE, ...
    valNELE, matNTVLST0, cellAIRFOIL, ROTOR, vecDVESYM, vecDVETRI] = fcnDUPBLADE( vecROTORVEH, vecDVEROTOR, ...
    ...
    vecDVETE, vecDVEROTORBLADE, vecDVESYMEDGE, matROTORAXIS, matNTVLST0, vecM, vecN, vecPANELROTOR, cellAIRFOIL, vecDVESYM, vecDVETRI)
...
for n = 1:valROTORS
    ...
    for j = 1:vecROTORBLADES(n)-1
        ...
        vecDVETRI = [vecDVETRI; vecDVETRI(idxDVEBLADE)];
        vecDVESYMEDGE = [vecDVESYMEDGE; vecDVESYMEDGE(idxDVEBLADE)];
