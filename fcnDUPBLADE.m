function [vecPANELROTOR, vecN, vecM, matVLST0, matCENTER0, matDVE, matADJE, vecDVEVEHICLE, ...
    ...
    valNELE, matNTVLST0, cellAIRFOIL, ROTOR, vecDVESYM] = fcnDUPBLADE( vecROTORVEH, vecDVEROTOR, ...
    ...
    vecDVETE, vecDVEROTORBLADE, vecDVESYMEDGE, matROTORAXIS, matNTVLST0, vecM, vecN, vecPANELROTOR, cellAIRFOIL, vecDVESYM)
