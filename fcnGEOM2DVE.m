...
vecPANELSURFACE = sort([uint16(INPU.vecPANELWING) uint16(INPU.vecPANELROTOR) + max(INPU.vecPANELWING).*uint16((INPU.vecPANELROTOR > 0))],2,'descend');
...
[SURF.matVLST, SURF.matCENTER, INPU.matROTORHUBGLOB, INPU.matROTORAXIS, SURF.matNPVLST, VEHI.vecBFRAME, INPU.vecVEHCG] = fcnROTVEHICLE( SURF.matDVE, SURF.matDVE, SURF.matVLST, SURF.matCENTER, INPU.valVEHICLES,...
    SURF.vecDVEVEHICLE, INPU.matVEHORIG, VEHI.matVEHROT, INPU.matROTORHUB, INPU.matROTORAXIS, VEHI.vecROTORVEH, SURF.matNTVLST, VEHI.vecBFRAME, INPU.vecVEHCG);
