function [Aircraft, FW] = generateDVEs(Aircraft, FW, ii)
...
% Aircraft.Surface(ii).Plot.PX = PX2(1:2:end,1:2:end);
% Aircraft.Surface(ii).Plot.PY = PY2(1:2:end,1:2:end);
% Aircraft.Surface(ii).Plot.PZ = PZ2(1:2:end,1:2:end);
