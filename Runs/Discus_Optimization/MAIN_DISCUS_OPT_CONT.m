...
delete ../../Optimization/opthistory_cont.txt
delete ../../Optimization/dvhistory_cont.txt
...
[x,fval,exitflag,output,population,scores] = ga({@fcnOBJECTIVE_CONT, N_bendstiff, N_torstiff, N_elasticaxis, N_massaxis, home_dir},nvars,A,b,[],[],lb,ub,[],IntCon,options);
