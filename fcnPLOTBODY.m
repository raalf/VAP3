function [hFig2] = fcnPLOTBODY(verbose, valNELE, matDVE, matVLST, matCENTER, dve_sym)
...
hold on
patch('Faces',matDVE(dve_sym,:),'Vertices',[matVLST(:,1) matVLST(:,2).*-1 matVLST(:,3)],'FaceColor',[255 90 90]./255)
