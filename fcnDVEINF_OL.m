function [a, b, c, d, e, f] = fcnDVEINF_OL(dvenum, dvetype, fpg, vecK, matDVE, matVLST, vecDVEHVSPN, vecDVEHVCRD, vecDVEROLL, vecDVEPITCH, vecDVEYAW, vecDVELESWP, vecDVETESWP, vecSYM, matESHEETS, flagGPU)
...
[a, b, c, d, e, f] = fcnDVEIND_OL(dvenum, dvetype, fpg, vecK, matDVE, matVLST, vecDVEHVSPN, vecDVEHVCRD, vecDVEROLL, vecDVEPITCH, vecDVEYAW, vecDVELESWP, vecDVETESWP, matESHEETS, flagGPU);

if any(vecSYM) == 1
    
    matVLSTs = [matVLST(:,1) -matVLST(:,2) matVLST(:,3)];
    
    [as, bs, cs, ds, es, fs] = fcnDVEIND_OL(dvenum, dvetype, fpg, vecK, matDVE, matVLSTs, vecDVEHVSPN, vecDVEHVCRD,-vecDVEROLL, vecDVEPITCH, -vecDVEYAW, -vecDVELESWP, -vecDVETESWP, matESHEETS, flagGPU);
