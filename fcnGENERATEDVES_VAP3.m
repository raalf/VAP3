function [matCENTER, vecDVEHVSPN, vecDVEHVCRD, vecDVELESWP, vecDVEMCSWP, vecDVETESWP, ...
    ...
    vecDVESYM, vecDVETIP, vecDVEWING, vecDVELE, vecDVETE, vecDVEPANEL, matNPVLST, vecM, vecN, matPANELTE] = fcnGENERATEDVES_VAP3(valPANELS, matGEOM, vecSYM, vecN, vecM)
...
[ vecDVEHVSPN, vecDVEHVCRD, ...
    ...
    matVLST, matDVE, ~, idxVLST] = fcnDVECORNER2PARAMTRI( matCENTER, P1, P2, P3, P4 );
